...
- [x] Added locally hosted logos for all 13 teams, verified against GameSheet team IDs, across directory, profiles, standings, schedule cards, and the homepage next game.
